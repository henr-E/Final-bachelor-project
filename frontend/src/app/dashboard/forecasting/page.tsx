        ...
        <div className="flex flex-col h-full">
            ...
            <div className="grid grid-cols-12 grow">
                <div className="col-span-9">
                    <PredictionMapImport twin={twinState.current} mode={PredictionMapMode.ForeCastingMode}/>
                </div>
                <div className="col-span-3 mx-6">
                    <div className="flex flex-col h-full">
                        <div className="grow">
                                <span
                                    className="mb-2 text-2xl leading-none text-bold tracking-tight text-gray-900 md:text-4xl lg:text-4xl dark:text-white">Simulation Configuration</span>
                            <br/>
                            <span
                                className="mb-2 text-1xl leading-none tracking-tight text-gray-600 md:text-3xl lg:text-3xl dark:text-white">{twinState.current.name}</span>
                                    ...
                                    <Accordion.Panel>
                                        ...
                                        <Accordion.Content>
                                            <div>
                                                ...
                                                <TextInput value={temperature} type="number" required
                                                           onChange={e => setTemperature(parseFloat(e.target.value))}/>
                                            </div>
                                            <div>
                                                <Label value="Rainfall (mm)"/>
                                                <TextInput value={rainfall} type="number" required
