...
import {Button, Card, RangeSlider, Spinner} from 'flowbite-react';
...
import {SimulationFrameRequest, SimulationId} from "@/proto/simulation/simulation-manager"
import {DeepPartial, Simulation, SimulationInterfaceServiceDefinition} from "@/proto/simulation/frontend";
                ...
                <div className="flex">
                    <div className="flex">
                        <a href="#" onClick={startStopSimulation}>
                            {(intervalItem) ? <Icon path={mdiPause} size={1.2}/> :
