...
import {CreateSimulationResponse, SimulationInterfaceServiceDefinition} from "@/proto/simulation/frontend";
import {SimulationManagerClient, SimulationManagerDefinition, SimulationFrameRequest} from "@/proto/simulation/simulation-manager"
                ...
                <div className="flex h-full grid grid-cols-12">
                    ...
                    <div className="col-span-3 mx-6">
                        <div className="h-full space-y-1">
                            <Button
                                onClick={()=>{ToastNotification("warning","Currently not implemented")}}
                                className="w-full"
                                color="indigo"
            ...
            <Card className="mt-1">
                <div className="flex">
                    ...
                    <div className="flex-auto">
                        <RangeSlider id="default-range" className="object-fill" onChange={(e)=>setCurrentTime(parseFloat(e.target.value))} value={currentTime.toString()}/>
                    </div>
                </div>
            </Card>
        </div>
