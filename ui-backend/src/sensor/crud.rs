//! Sensor CRUD service.
//!
//! This module includes the implemenation of the `SensorCrudService` and some helper
...
use sensor_store::{Quantity, Sensor, Unit};
...
/// Convert sensor message from protobuf to [`sensor_store::Sensor`].
...
impl SensorCrudService for SensorStore {
    ...
    /// Create a sensor given its [`Uuid`].
    ///
